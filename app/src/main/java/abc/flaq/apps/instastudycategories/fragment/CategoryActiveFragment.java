...
public class CategoryActiveFragment extends Fragment {
    ...
    private void setBroadcastReceivers() {
        ActiveCategoriesBroadcastReceiver receiver = new ActiveCategoriesBroadcastReceiver();
        IntentFilter filter = new IntentFilter();
        filter.addAction(INTENT_CATEGORY);
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(receiver, filter);
    }

    private class ActiveCategoriesBroadcastReceiver extends BroadcastReceiver {
        @Override
